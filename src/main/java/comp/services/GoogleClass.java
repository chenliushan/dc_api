...
public class GoogleClass {
    ...
    private static final String APPLICATION_NAME = "dc_api";
    private static final String REDIRECT_URI = "http://localhost:8080/googlecode";
    ...
    static GoogleAuthorizationCodeFlow getFlow() throws IOException {
        if (flow == null) {
            InputStream in =
                    GoogleClass.class.getResourceAsStream(CLIENTSECRET_LOCATION);
    ...
    public static Credential getCredentials(String authorizationCode, String state)
        ...
        try {
            ...
            System.out.println("getRefreshToken:"+credentials.getRefreshToken());
            return credentials;
